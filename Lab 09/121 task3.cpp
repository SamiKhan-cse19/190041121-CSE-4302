...
public:
    ...
    Furniture(double p,double d,Material m,string name):price(0),discount(0),madeof(Material::Wood)
    {
        setPrice(p);
        setDiscount(d);
        setMadeof(m);
...
private:
    BedSize bedSize;
public:
    Bed() : Furniture(0.0f, 0.0f, Material::Wood, string("")){
    }
    Bed(double p, double d, Material m, BedSize bs, string name="") : Furniture(p, d, m, name), bedSize(bs) {
...
public:
    Sofa() : Furniture(0.0f, 0.0f, Material::Wood, string("")) {
    }
    Sofa(double p,double d,Material m, SofaSize sn, string name="") : Furniture(p, d, m, name), sofaSize(sn) {
...
public:
    Almirah() : Furniture(0.0f, 0.0f, Material::Wood, string("")) {
    }
    Almirah(double p,double d,Material m, AlmirahSize dr, string name="") : Furniture(p, d, m, name), almirahSize(dr) {
...
int main()
{
    ...
    */
    f_list[0] = new Bed(10000,123,Material::Wood,BedSize::Single, "Bahari Bed");
